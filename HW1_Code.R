...
print('Since the histogram data trend matches with poisson distribution, it is consistent with Poisson distribution')
...
#Selecting identifying the result of the match
